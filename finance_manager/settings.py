...
SECRET_KEY = 'django-insecure-u$nlc)!zv9e-w4+(64g+xb=e^x8!7_7t9e4y_ctx#=d*)ssdg!'
...
JAZZMIN_SETTINGS = {
    ...
    "site_brand": "Finance manager",
    "site_icon": "images/favicon.png",
    # Add your own branding here
    "site_logo": None,
    "welcome_sign": "Welcome to the finance manager",
    ...
    "topmenu_links": [
        ...
        {"name": "Finance manager", "url": "home", "permissions": ["auth.view_user"]},
